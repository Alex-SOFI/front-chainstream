...
const BlaiseLanding: React.FC = () => {
    const year = new Date().getFullYear();

    const handleSubmit = (e: React.FormEvent<HTMLFormElement>) => {
        e.preventDefault();
        // TODO: plug into your waitlist backend / API
    };
            ...
            <div className="mx-auto flex min-h-screen max-w-6xl flex-col px-4 pb-16 pt-6 sm:px-6 lg:px-8">
                ...
                <header className="mb-10 flex items-center justify-between">
                    <div className="flex items-center gap-2">
                        ...
                        />
                        <span className="text-base font-semibold tracking-tight">blaise</span>
                    </div>
                ...
                <main className="flex flex-1 flex-col gap-16">
                    ...
                    <section className="mt-6 grid gap-10 lg:grid-cols-[minmax(0,3fr)_minmax(0,2fr)] lg:items-center">
                        ...
                        <div>
                            ...
                            <p className="mt-5 max-w-xl text-sm text-white/70 sm:text-[15px]">
                                Blaise is building a new way for individuals to take part in
                            ...
                            <div id="waitlist" className="mt-8 max-w-xl">
                                ...
                                >
                                    <div className="flex w-full flex-1 items-center rounded-full border border-white/18 bg-white/5 px-3 py-2">
                                        ...
                                        <button
                                            type="submit"
                                            className="rounded-full bg-[#00FF66] px-4 py-1.5 text-xs font-semibold text-black hover:bg-[#34ff84] transition"
                                        >
                                            Join
                                        </button>
                                    </div>
                    ...
                    <section id="what" className="space-y-6">
                        <div className="max-w-3xl">
                            <h2 className="text-2xl font-semibold tracking-tight">
                                What Blaise is aiming to change
                            </h2>
                    ...
                    >
                        <div>
                            <h2 className="text-2xl font-semibold tracking-tight">
                                How Blaise could fit into your investing
                            </h2>
                            <p className="mt-2 max-w-3xl text-sm text-white/70 sm:text-[15px]">
                                Blaise is not designed to replace what you already do with listed
                    ...
                    <section id="next" className="space-y-5">
                        ...
                        <p className="max-w-2xl text-sm text-white/70 sm:text-[15px]">
                            Blaise is not live yet. The first phase is about building the
                        ...
                        <div className="grid gap-4 md:grid-cols-3">
                            ...
                            <div className="rounded-2xl border border-white/10 bg-white/5 p-4">
                                ...
                                <p className="mt-2 text-xs text-white/70">
                                    ...
                                    Blaise is, what it is not, and how it can play a role in your
                                    decisions.
                                </p>
                            </div>
                        </div>
                    ...
                    <section className="space-y-2 text-[11px] text-white/45">
                        <p>
                            ...
                            Blaise will be subject to specific terms, conditions and applicable
